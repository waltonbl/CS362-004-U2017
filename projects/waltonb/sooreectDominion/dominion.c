...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
		adventurerCard(state, currentPlayer, temphand, drawntreasure, cardDrawn, z);
		break;
    ...
    case feast:
		feastCard(choice1, state, currentPlayer, temphand);
		break;
    ...
    case cutpurse:
		cutPurseCard(state, handPos, currentPlayer);
		break;
...
//4 of these 5 functions contain bugs
